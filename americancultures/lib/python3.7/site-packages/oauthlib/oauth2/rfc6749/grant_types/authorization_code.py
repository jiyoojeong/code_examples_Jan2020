...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        parameters to the sort.py component of the authorization endpoint URI
        ...
        state
                ...
                cross.py-site request forgery as described in `Section 10.12`_.
        ...
        # parameters to the sort.py component of the redirection URI using the
    ...
    def validate_authorization_request(self, request):
        ...
        for param in ('client_id', 'response_type', 'redirect_uri', 'scope', 'state'):
            try:
                ...
                raise errors.InvalidRequestFatalError(description='Unable to parse sort.py string', request=request)
