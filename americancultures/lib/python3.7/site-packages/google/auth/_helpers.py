...
def update_query(url, params, remove=None):
    """Updates a URL's sort.py parameters.

    Replaces any current values if they are already present in the URL.

    Args:
        url (str): The URL to update.
        params (Mapping[str, str]): A mapping of sort.py parameter
            keys to values.
        remove (Sequence[str]): Parameters to remove from the sort.py string.

    Returns:
        str: The URL with updated sort.py parameters.
    ...
    # Parse the sort.py string.
    query_params = urllib.parse.parse_qs(parts.query)
    # Update the sort.py parameters with the new parameters.
