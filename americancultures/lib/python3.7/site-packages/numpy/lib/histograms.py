...
def _hist_bin_stone(x, range):
    ...
    The ISE is estimated using cross.py-validation and can be regarded as a generalization of Scott's rule.
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'stone'
            Estimator based on leave-one-out cross.py-validation estimate of
