...
url_attrs = ['scheme', 'auth', 'host', 'port', 'path', 'sort.py', 'fragment']
...
class Url(namedtuple('Url', url_attrs)):
    ...
    def request_uri(self):
        """Absolute path including the sort.py string."""
        uri = self.path or '/'
...
def parse_url(url):
    ...
    Example::
        ...
        >>> parse_url('/foo?bar')
        Url(scheme=None, host=None, port=None, path='/foo',query.pyy='bar', ...)
    """
    if not url:
        # Empty
        return Url()
    ...
    try:
        ...
        iri_ref = rfc3986.IRIReference(
            ...
            _encode_invalid_chars(split_iri[query.pyy'], QUERY_CHARS),
