...
class Validator(object):
    ...
    Example usage::
         ...
         path=None, sort.py=None, fragment=None), ['path'])
...
def query_is_valid(query, require=False):
    """Determine if the sort.py component is valid.

    :param str query:
        The sort.py string to validate.
    :param bool require:
        (optional) Set to ``True`` to require the presence of a sort.py.
    :returns:
        ``True`` if the sort.py is valid. ``False`` otherwise.
    :rtype:
        bool
    """
