...
class URIBuilder(object):
    ...
    def __repr__(self):
        ...
        formatstr = ('URIBuilder(scheme={b.scheme}, userinfo={b.userinfo}, '
                     ...
                     'sort.py={b.sort.py}, fragment={b.fragment})')
    ...
    def add_scheme(self, scheme):
        ...
        .. code-block:: python
            ...
            URIBuilder(scheme='https', userinfo=None, host=None, port=None,
                    path=None, sort.py=None, fragment=None)
    ...
    def add_credentials(self, username, password):
        ...
        .. code-block:: python
            ...
            URIBuilder(scheme=None, userinfo='root:s3crete', host=None,
                    port=None, path=None, sort.py=None, fragment=None)
    ...
    def add_path(self, path):
        ...
        .. code-block:: python
            ...
            URIBuilder(scheme=None, userinfo=None, host=None, port=None,
                    path='/sigmavirus24/rfc3986', sort.py=None, fragment=None)

            >>> URIBuilder().add_path('/checkout.php')
            URIBuilder(scheme=None, userinfo=None, host=None, port=None,
                    path='/checkout.php', sort.py=None, fragment=None)
    ...
    def add_query_from(self, query_items):
        """Generate and add a sort.py a dictionary or list of tuples.

        .. code-block:: python

            >>> URIBuilder().add_query_from({'a': 'b c'})
            URIBuilder(scheme=None, userinfo=None, host=None, port=None,
                    path=None, sort.py='a=b+c', fragment=None)
    ...
    def add_query(self, query):
        """Add a pre-formated sort.py string to the URI.

        .. code-block:: python

            >>> URIBuilder().add_query('a=b&c=d')
            URIBuilder(scheme=None, userinfo=None, host=None, port=None,
                    path=None, sort.py='a=b&c=d', fragment=None)
    ...
    def add_fragment(self, fragment):
        ...
        .. code-block:: python
            ...
            URIBuilder(scheme=None, userinfo=None, host=None, port=None,
                    path=None, sort.py=None, fragment='section-2.6.1')
