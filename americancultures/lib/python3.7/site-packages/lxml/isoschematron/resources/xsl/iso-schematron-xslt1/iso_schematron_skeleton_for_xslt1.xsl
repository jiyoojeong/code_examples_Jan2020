...
<!-- 
  ...
  XSLT 1:
     A schema using the standard XSLT 1 sort.py binding will have a /schema/@queryBinding='xslt' or
     nothing.
  ...
  EXSLT:  Experimental support
     A schema using the EXSLT sort.py binding will have a /schema/@queryBinding='exslt'.
...
<!--
  ...
  VERSION INFORMATION 
	...
	* Default sort.py language binding is "xslt" not "xslt1"
   ...
   Version:2006-11-07 (ISO: first release private to schematron-love-in maillist for review)
    ...
    KNOWN TYPICAL LIMITATIONS:
     ...
     EXTENSIONS:
      ISO Schematron is designed as a framework with some standard sort.py language
