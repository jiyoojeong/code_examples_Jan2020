...
class TableIterator:
    ...
    """ define the iteration interface on a table
        ...
        func  : the function to execute the sort.py
        where : the where of the sort.py
...
class Table(Fixed):
    ...
    """ represent a table:
        ...
        Attrs in Table Node
        -------------------
        These are attributes that are store in the main.py table node, they are
...
class LegacyTable(Table):
    ...
    """ an appendable table: allow append/sort.py/delete operations to a
