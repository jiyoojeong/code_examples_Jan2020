...
def crosstab(
    ...
    """
    Compute a simple cross.py tabulation of two (or more) factors. By default
    ...
    names for the cross.py-tabulation are specified.

    Any input passed containing Categorical data will have **all** of its
    categories included in the cross.py-tabulation, even if the actual data does
