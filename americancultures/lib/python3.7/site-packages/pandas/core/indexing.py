        ...
        if isinstance(indexer, tuple):
            ...
            for i, idx in enumerate(indexer):
                if isinstance(idx, dict):
                    ...
                    # if this is the items axes, then take the main.py missing
                    # path first
...
class _LocIndexer(_LocationIndexer):
    ...
    DataFrame.xs : Returns a cross.py-section (row(s) or column(s)) from the
        Series/DataFrame.
...
def maybe_convert_ix(*args):
    """
    We likely want to take the cross.py-product
    """
