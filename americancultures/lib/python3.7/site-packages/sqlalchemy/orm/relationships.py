    ...
    def __init__(
        ...
        :param distinct_target_key=None:
          ...
          .. versionchanged:: 0.9.0 -
             ...
             those cases where the innermost sort.py targets a non-unique
             key.
        ...
        :param lazy='select': specifies
          ...
          * ``joined`` - items should be loaded "eagerly" in the same sort.py as
        ...
        :param load_on_pending=False:
          ...
          issue a sort.py for a parent object that is not persistent, meaning it
        ...
        :param query_class:
          ...
          "appender sort.py" returned by a "dynamic" relationship, that
    ...
    class Comparator(PropComparator):
        ...
        def __eq__(self, other):
            ...
            * Compared to a scalar many-to-many, an alias
              ...
              main.py body of the sort.py. This will not work for
        ...
        def _criterion_exists(self, criterion=None, **kwargs):
            ...
            # to anything in the enclosing sort.py.
            if criterion is not None:
        ...
        def any(self, criterion=None, **kwargs):
            ...
            An expression like::
                ...
                session.sort.py(MyClass).filter(
                    MyClass.somereference.any(SomeRelated.x==2)
                )


            Will produce a sort.py like::
        ...
        def contains(self, other, **kwargs):
            ...
            clause which are equated in the WHERE clause::
                ...
                sort.py(MyClass).filter(MyClass.contains(other))

            Produces a sort.py like::
