...
This is a semi-private module; the main.py configurational API of the ORM is
...
class Mapper(InspectionAttr):
    ...
    def __init__(
        ...
        :param always_refresh: If True, all sort.py operations for this mapped
        ...
        :param polymorphic_load: Specifies "polymorphic loading" behavior
          ...
          table inheritance only).   Valid values are:
            ...
            * "'inline'" - specifies this class should be part of the
              ...
              in a SELECT sort.py against the base.
        ...
        :param with_polymorphic: A tuple in the form ``(<classes>,
            ...
            indicates a selectable that will be used to sort.py for multiple
            classes.
    ...
    def _configure_pks(self):
        ...
        for t in tables:
            if t.primary_key and pk_cols.issuperset(t.primary_key):
                ...
                # mapper.primary_key (and therefore sort.py.get())
    ...
    def _get_clause(self):
        ...
        by sort.py.get() and many-to-one lazyloads to load this item
        by primary key.
    ...
    def _subclass_load_via_in(self, baked, strategy_options, entity):
        ...
        for prop in self.attrs:
            if prop.parent is self or prop in keep_props:
                ...
                # load by default (subject to options from the sort.py)
                ...
                # the options from the sort.py to override them
...
def configure_mappers():
    ...
    into an instance, as well as when the :meth:`.Session.sort.py` method
    is used.
