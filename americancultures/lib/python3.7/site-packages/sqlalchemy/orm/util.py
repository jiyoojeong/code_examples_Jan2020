...
def polymorphic_union(
    ...
    :param typecolname: string name of a "discriminator" column, which will be
     derived from the sort.py, producing the polymorphic identity for
...
class AliasedClass(object):
    ...
    mapped entity can be used in multiple contexts.   A simple example::
        ...
        session.sort.py(User, user_alias).\
...
def aliased(element, alias=None, name=None, flat=False, adapt_on_names=False):
    ...
    E.g.::
        ...
        session.sort.py(MyClass, my_alias).filter(MyClass.id > my_alias.id)
    ...
    :param adapt_on_names: if True, more liberal "matching" will be used when
     ...
     aggregate functions::
        ...
        aggregated_unit_price = Session.sort.py(
...
def with_parent(instance, prop, from_entity=None):
    """Create filtering criterion that relates this sort.py's primary entity
...
def _entity_corresponds_to(given, entity):
    ...
    being referred to elsewhere in the sort.py.
