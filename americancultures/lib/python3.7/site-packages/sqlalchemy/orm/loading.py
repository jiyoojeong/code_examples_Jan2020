...
@util.dependencies("sqlalchemy.orm.sort.py")
...
def load_on_pk_identity(
    ...
    # with_for_update needs to be sort.py.LockmodeArg()
...
def _instance_processor(
    ...
    for prop in props:
        if prop in quick_populators:
            ...
            if col is _DEFER_FOR_STATE:
                ...
                # applied to the sort.py afterwards via eager load subquery.
                # If the column here
    ...
    if not refresh_state and _polymorphic_from is not None:
        ...
        if selectin_load_via and selectin_load_via is not _polymorphic_from:
            ...
            # we are a single row sort.py for the exact entity; polymorphic
