...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param autoflush: When ``True``, all sort.py operations will issue a
        ...
        :param enable_baked_queries: defaults to ``True``.  A flag consumed
           ...
           (such as relationship loaders).   Additionally, baked sort.py
        ...
        :param query_cls:  Class which should be used to create new Query
          objects, as returned by the :meth:`~.Session.sort.py` method.
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        operation such as a :meth:`.Session.sort.py`, each
    ...
    def no_autoflush(self):
        ...
        e.g.::
            ...
            with session.no_autoflush:
                ...
                # won't autoflush
                some_object.related_thing = session.sort.py(SomeRelated).first()

        Operations that proceed within the ``with:`` block
        will not be subject to flushes occurring upon sort.py
    ...
    def refresh(
        ...
        A sort.py will be issued to the database and all attributes will be
        ...
        :param lockmode: Passed to the :class:`~sqlalchemy.orm.sort.py.Query`
          as used by :meth:`~sqlalchemy.orm.sort.py.Query.with_lockmode`.
    ...
    def expire_all(self):
        ...
        a sort.py will be issued using the
    ...
    def expire(self, instance, attribute_names=None):
        ...
        attribute is next accessed, a sort.py will be issued to the
        :class:`.Session` object's current transactional context in order to
        load all expired attributes for the given instance.   Note that
        a highly isolated transaction will return the same values as were
        previously read in that same transaction, regardless of changes
...
def make_transient(instance):
    ...
    .. warning::
        ...
        * were not present in the sort.py which loaded this object, such as that
...
def make_transient_to_detached(instance):
    ...
    from a sort.py.  Missing attributes will be marked as expired.
