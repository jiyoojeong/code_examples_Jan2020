...
class MapperProperty(_MappedAttribute, InspectionAttr, util.MemoizedSlots):
    ...
    def setup(self, context, query_entity, path, adapter, **kwargs):
        ...
        statement referenced by the sort.py context, adding columns and/or
...
class PropComparator(operators.ColumnOperators):
    ...
    def of_type(self, class_):
        ...
        e.g.::
            ...
            sort.py.join(Company.employees.of_type(Engineer)).\
...
class MapperOption(object):
    ...
    def _generate_cache_key(self, path):
        ...
        This loader generates SQL for a sort.py only once and attempts to  cache
        ...
        SQL or other sort.py state that has been affected by the
        :class:`.MapperOption` may be cached in place of a sort.py that does not
        ...
        would not affect sort.py results on such a path, it should return None,
