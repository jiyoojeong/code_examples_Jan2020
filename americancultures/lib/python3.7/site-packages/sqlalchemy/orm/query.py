...
class Query(object):
    ...
    ORM, both those formulated by end-user sort.py operations as well as by
    ...
    :meth:`~.Session.sort.py` method of :class:`.Session`, and in
    ...
    when a sort.py is being used to lazy load a relationship on an object.
    ...
    def __init__(self, entities, session=None):
        ...
        The above is equivalent to::
            ...
            q = some_session.sort.py(User, Address)
    ...
    def _set_entities(self, entities, entity_wrapper=None):
        ...
        #    from session.sort.py() which takes in *entities.
    ...
    def _adapt_clause(self, clause, as_filter, orm_only):
        ...
        have been applied within this sort.py."""
        ...
        if self._from_obj_alias:
            ...
            # 'ORM only' check, if this sort.py were generated from a
    ...
    def subquery(self, name=None, with_labels=False, reduce_columns=False):
        ...
        Eager JOIN generation within the sort.py is disabled.
    ...
    def cte(self, name=None, recursive=False):
        ...
        directly::
            ...
            included_parts = session.sort.py(
                            Part.sub_part,
                            Part.part,
                            Part.quantity).\
    ...
    def selectable(self):
        ...
        Used for :func:`.inspect` compatibility, this is equivalent to::
            ...
            sort.py.enable_eagerloads(False).with_labels().statement
    ...
    def only_return_tuples(self, value):
        """When set to True, the sort.py results will always be a tuple,
    ...
    def _no_yield_per(self, message):
        raise sa_exc.InvalidRequestError(
            ...
            "specify lazyload('*') or sort.py.enable_eagerloads(False) in "
            "order to "
            "proceed with sort.py.yield_per()." % message
        )
    ...
    def with_labels(self):
        ...
        .. note:: The :meth:`.Query.with_labels` method *only* applies
           ...
           a sort.py using :meth:`.Query.with_labels`, invoke the
           :attr:`.Query.statement` using :meth:`.Session.execute`::

                result = session.execute(sort.py.with_labels().statement)
    ...
    def _with_current_path(self, path):
        """indicate that this sort.py applies to objects loaded
        within a certain path.

        Used by deferred loaders (see strategies.py) which transfer
        sort.py options from an originating sort.py to a newly generated
        sort.py intended for the deferred load.
    ...
    def with_polymorphic(
        ...
        to the "main.py" mapped class represented by this :class:`.Query`.
        The "main.py" mapped class here means the :class:`.Query`
        object's first argument is a full class, i.e.
        ``session.sort.py(SomeClass)``. These transformations allow additional
        tables to be present in the FROM clause so that columns for a
        joined-inheritance subclass are available in the sort.py, both for the
        purposes of load-time efficiency as well as the ability to use
        these columns at sort.py time.
    ...
    def yield_per(self, count):
        ...
        .. warning::
            ...
            :meth:`~sqlalchemy.orm.sort.py.Query.yield_per`.

            Also note that while
            :meth:`~sqlalchemy.orm.sort.py.Query.yield_per` will set the
            ...
            instead of pre-buffer all rows for this sort.py. Other
    ...
    def get(self, ident):
        ...
        E.g.::
            ...
            my_user = session.sort.py(User).get(5)

            some_object = session.sort.py(VersionedFoo).get((5, 10))

            some_object = session.sort.py(VersionedFoo).get(
                {"id": 5, "version_id": 10})
        ...
        :param ident: A scalar, tuple, or dictionary representing the
         ...
         store the object's primary key value, the call would look like::
            ...
            my_object = sort.py.get({"id": 5, "version_id": 10})
    ...
    def _identity_lookup(
        ...
        mapper is passed::
            ...
            obj = session.sort.py()._identity_lookup(inspect(SomeClass), (1, ))
    ...
    def _get_impl(self, primary_key_identity, db_load_fn, identity_token=None):
        ...
        if len(primary_key_identity) != len(mapper.primary_key):
            raise sa_exc.InvalidRequestError(
                ...
                "primary key for sort.py.get(); primary key columns are %s"
        ...
        if is_dict:
            try:
                ...
                raise sa_exc.InvalidRequestError(
                    ...
                    "primary key for sort.py.get(); primary key attribute names"
                    " are %s"
                    % ",".join(
                        "'%s'" % prop.key
                        for prop in mapper._identity_key_props
    ...
    def with_session(self, session):
        ...
        :meth:`.Session.sort.py` method, it is legal to build the :class:`.Query`
        ...
        object associated with a target session using this method::
            ...
            sort.py = Query([MyClass]).filter(MyClass.id == 5)

            result = sort.py.with_session(my_session).one()
    ...
    def from_self(self, *entities):
        ...
        into a SELECT of itself.  Given a sort.py such as::

            q = session.sort.py(User).filter(User.name.like('e%'))

        Given the :meth:`.Query.from_self` version::

            q = session.sort.py(User).filter(User.name.like('e%')).from_self()

        This sort.py renders as:
        ...
        the set of user objects we sort.py against, and then apply additional
        ...
        The above sort.py joins to the ``Address`` entity but only against the
        first five results of the ``User`` sort.py:
        ...
        **Changing the Entities**
        ...
        to be queried by the inner sort.py, so that we can join to the
        ``Address`` entity on the outside, but we only wanted the outer
        sort.py to return the ``Address.email`` column::
        ...
        **Looking out for Inner / Outer Columns**
        ...
        the ``User`` columns::
            ...
            q = session.sort.py(Address).join(Address.user).\
    ...
    def execution_options(self, **kwargs):
        ...
        automatically if the :meth:`~sqlalchemy.orm.sort.py.Query.yield_per()`
        method is used.
    ...
    def with_for_update(
        ...
        E.g.::
            ...
            q = sess.sort.py(User).with_for_update(nowait=True, of=User)

        The above sort.py on a PostgreSQL backend will render like::
    ...
    def filter(self, *criterion):
        ...
        e.g.::
            ...
            session.sort.py(MyClass).filter(MyClass.name == 'some name')

        Multiple criteria may be specified as comma separated; the effect
        is that they will be joined together using the :func:`.and_`
        function::

            session.sort.py(MyClass).\
    ...
    def filter_by(self, **kwargs):
        ...
        e.g.::
            ...
            session.sort.py(MyClass).filter_by(name = 'some name')
        ...
        entity of the sort.py, or the last entity that was the
    ...
    def order_by(self, *criterion):
        """apply one or more ORDER BY criterion to the sort.py and return
    ...
    def group_by(self, *criterion):
        """apply one or more GROUP BY criterion to the sort.py and return
    ...
    def having(self, criterion):
        r"""apply a HAVING criterion to the sort.py and return the
    ...
    def union(self, *q):
        ...
        e.g.::
            ...
            q1 = sess.sort.py(SomeClass).filter(SomeClass.foo=='bar')
            q2 = sess.sort.py(SomeClass).filter(SomeClass.bar=='foo')
        ...
        be rendered on a sort.py called within UNION, EXCEPT, etc.
        To disable all ORDER BY clauses including those configured
        on mappers, issue ``sort.py.order_by(None)`` - the resulting
    ...
    def union_all(self, *q):
        ...
        Works the same way as :meth:`~sqlalchemy.orm.sort.py.Query.union`. See
    ...
    def join(self, *props, **kwargs):
        ...
        **Simple Relationship Joins**
        ...
        for how this should occur::
            ...
            q = session.sort.py(User).join(User.addresses)
        ...
        single-entity sort.py such as the one above (i.e. we start by selecting
        only from ``User`` and nothing else), the relationship can also be
        specified by its string name::

            q = session.sort.py(User).join("addresses")
        ...
        where a join across four related entities is constructed::
            ...
            q = session.sort.py(User).join("orders", "items", "keywords")
        ...
        **Joins to a Target Entity or Selectable**
        ...
        two entities::
            ...
            q = session.sort.py(User).join(Address)
        ...
        be any mapped entity or selectable, such as a :class:`.Table`::
            ...
            q = session.sort.py(User).join(addresses_table)
        ...
        **Joins to a Target with an ON Clause**
        ...
        entity in some way as well as an applicable source entity::
            ...
            q = session.sort.py(User).join(Address, User.id==Address.user_id)
        ...
        **Advanced Join Targeting and Adaption**
        ...
        ``User.addresses`` to *adapt* itself to the altered target::
            ...
            address_subq = session.sort.py(Address).\
                            filter(Address.email_address == 'ed@foo.com').\
                            subquery()

            q = session.sort.py(User).join(address_subq, User.addresses)
        ...
        **Constructing Aliases Anonymously**
        ...
        when a sort.py is being joined algorithmically, such as
        when querying self-referentially to an arbitrary depth::

            q = session.sort.py(Node).\
        ...
        an XPath-like sort.py system using algorithmic joins.
    ...
    def _join(self, keys, outerjoin, full, create_aliases, from_joinpoint):
        ...
        for idx, arg1 in enumerate(keylist):
            ...
            if isinstance(onclause, util.string_types):
                # string given, e.g. sort.py(Foo).join("bar").
            ...
            if isinstance(onclause, interfaces.PropComparator):
                ...
                if not create_aliases:
                    ...
                    if edge in self._joinpoint:
                        ...
                        # shared by a different sort.py object.
    ...
    def _join_determine_implicit_left_side(self, left, right, onclause):
        ...
        determine if an existing FROM or entity in this sort.py
        ...
        if self._from_obj:
            ...
            for entity_index, ent in enumerate(self._entities):
                ...
                # de-duplicates those selectables as occurs when the sort.py is
    ...
    def _join_check_and_adapt_right_side(
        ...
        according to polymorphic mapping translations, aliasing on the sort.py
        ...
        if r_info.is_clause_element:
            ...
            if right_selectable._is_lateral:
                ...
                raise sa_exc.InvalidRequestError(
                    "The aliased=True parameter on sort.py.join() only works "
    ...
    def reset_joinpoint(self):
        ...
        been reset back to the base FROM entities of the sort.py.
    ...
    def select_entity_from(self, from_obj):
        ...
        explicitly throughout a sort.py.  Instead of referring to the
        ...
        objects from a SELECT statement::
            ...
            q = session.sort.py(user_alias).\
                filter(user_alias.name == 'ed')

        Above, we apply the ``user_alias`` object explicitly throughout the
        sort.py.  When it's not feasible for ``user_alias`` to be referenced
        explicitly in many places, :meth:`.Query.select_entity_from` may be
        used at the start of the sort.py to adapt the existing ``User`` entity::
        ...
        of the sort.py.  The difference is that it additionally applies
        adaptation to the other parts of the sort.py that refer to the
        ...
        :meth:`.TextClause.columns` method::
            ...
            text_stmt = text("select id, name from user").columns(
                User.id, User.name)
            q = session.sort.py(User).select_entity_from(text_stmt)
    ...
    def slice(self, start, stop):
        ...
        For example, ::
            ...
            session.sort.py(User).order_by(User.id).slice(1, 3)
    ...
    def limit(self, limit):
        """Apply a ``LIMIT`` to the sort.py and return the newly resulting
        ``Query``.
    ...
    def offset(self, offset):
        """Apply an ``OFFSET`` to the sort.py and return the newly resulting
        ``Query``.
    ...
    def distinct(self, *expr):
        r"""Apply a ``DISTINCT`` to the sort.py and return the newly resulting
        ``Query``.
        ...
        .. note::
            ...
            add columns from the ORDER BY of the sort.py to the columns
    ...
    def prefix_with(self, *prefixes):
        r"""Apply the prefixes to the sort.py and return the newly resulting
        ``Query``.
        ...
        e.g.::
            ...
            sort.py = sess.sort.py(User.name).\
    ...
    def suffix_with(self, *suffixes):
        r"""Apply the suffix to the sort.py and return the newly resulting
        ``Query``.
    ...
    def all(self):
        ...
        This results in an execution of the underlying sort.py.
    ...
    def one_or_none(self):
        ...
        Returns ``None`` if the sort.py selects
        no rows.  Raises ``sqlalchemy.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a sort.py that returns only scalar values
    ...
    def one(self):
        ...
        Raises ``sqlalchemy.orm.exc.NoResultFound`` if the sort.py selects
        no rows.  Raises ``sqlalchemy.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a sort.py that returns only scalar values
        as opposed to full identity-mapped entities.

        Calling :meth:`.one` results in an execution of the underlying sort.py.
    ...
    def scalar(self):
        ...
        raises MultipleResultsFound.
          ...
          >>> session.sort.py(Item).scalar()
          <Item>
          >>> session.sort.py(Item.id).scalar()
          1
          >>> session.sort.py(Item.id).filter(Item.id < 0).scalar()
          None
          >>> session.sort.py(Item.id, Item.name).scalar()
          1
          >>> session.sort.py(func.count(Parent.id)).scalar()
          20
    ...
    def column_descriptions(self):
        ...
        Format is a list of dictionaries::
            ...
            q = sess.sort.py(User, User.id, user_alias)
    ...
    def instances(self, cursor, __context=None):
        ...
        e.g.::
            ...
            for u in session.sort.py(User).instances(result):
                print u
        """
        context = __context
        if context is None:
    ...
    def exists(self):
        """A convenience method that turns a sort.py into an EXISTS subquery
        of the form EXISTS (SELECT 1 FROM ... WHERE ...).

        e.g.::

            q = session.sort.py(User).filter(User.name == 'fred')
            session.sort.py(q.exists())
        ...
        The EXISTS construct is usually used in the WHERE clause::
            ...
            session.sort.py(User.id).filter(q.exists()).scalar()
        ...
        as a WHERE, use :func:`.literal`::
            ...
            session.sort.py(literal(True)).filter(q.exists()).scalar()

        """

        # .add_columns() for the case that we are a sort.py().select_from(X),
        # so that ".statement" can be produced (#2995) but also without
        # omitting the FROM clause from a sort.py(X) (#2818);
    ...
    def count(self):
        ...
        This generates the SQL for this Query as follows::
            ...
            SELECT count(1) AS count_1 FROM (
                SELECT <rest of sort.py follows...>
            ) AS anon_1
        ...
        with :meth:`~.Session.sort.py`, i.e.::

            from sqlalchemy import func

            # count User records, without
            # using a subquery.
            session.sort.py(func.count(User.id))
            ...
            session.sort.py(func.count(distinct(User.name)))
    ...
    def delete(self, synchronize_session="evaluate"):
        r"""Perform a bulk delete sort.py.

        Deletes rows matched by this sort.py from the database.

        E.g.::

            sess.sort.py(User).filter(User.age == 25).\
        ...
        :param synchronize_session: chooses the strategy for the removal of
            ...
            ``'fetch'`` - performs a select sort.py before the delete to find
            objects that are matched by the delete sort.py and need to be
            removed from the session. Matched objects are removed from the
            session.

            ``'evaluate'`` - Evaluate the sort.py's criteria in Python straight
        ...
        .. warning:: **Additional Caveats for bulk sort.py deletes**
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        r"""Perform a bulk update sort.py.

        Updates rows matched by this sort.py in the database.
        ...
        :param synchronize_session: chooses the strategy to update the
         attributes on objects in the session. Valid values are:
            ...
            ``'fetch'`` - performs a select sort.py before the update to find
            objects that are matched by the update sort.py. The updated
        ...
        .. warning:: **Additional Caveats for bulk sort.py updates**
    ...
    def _compound_eager_statement(self, context):
        ...
        # wrap the sort.py inside a select,
        ...
        # put FOR UPDATE on the inner sort.py, where MySQL will honor it,
    ...
    def _adjust_for_single_inheritance(self, context):
        ...
        the columns clause of this sort.py, as well as the "select from entity",
...
class _MapperEntity(_QueryEntity):
    ...
    def set_with_polymorphic(
        ...
        """Receive an update from a call to sort.py.with_polymorphic().
...
class Bundle(InspectionAttr):
    ...
    def __init__(self, name, *exprs, **kw):
        ...
        e.g.::
            ...
            for row in session.sort.py(bn).filter(
    ...
    """A namespace of SQL expressions referred to by this :class:`.Bundle`.
        ...
        e.g.::
            ...
            q = sess.sort.py(bn).filter(bn.c.x == 5)
...
class _ColumnEntity(_QueryEntity):
    ...
    def __init__(self, query, column, namespace=None):
        ...
        # leaking out their entities into the main.py select construct
...
class AliasOption(interfaces.MapperOption):
    def __init__(self, alias):
        ...
        that the main.py table has been aliased.
        ...
        statement that aliases the parent table.  E.g.::
            ...
            # create sort.py, indicating "ulist" will be an
            # alias for the main.py table, "addresses"
            # property should be eager loaded
            sort.py = session.sort.py(User).options(
                                    contains_alias(ulist),
                                    contains_eager(User.addresses))

            # then get results via the statement
            results = sort.py.from_statement(statement).all()
