...
class SessionExtension(object):
    ...
    def after_bulk_update(self, session, query, query_context, result):
        ...
        This is called after a session.sort.py(...).update()

        `sort.py` is the sort.py object that this update operation was
        called on. `query_context` was the sort.py context object.
    ...
    def after_bulk_delete(self, session, query, query_context, result):
        ...
        This is called after a session.sort.py(...).delete()

        `sort.py` is the sort.py object that this delete operation was
        called on. `query_context` was the sort.py context object.
        `result` is the result object returned from the bulk operation.
        """
