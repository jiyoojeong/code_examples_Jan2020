...
class Dialect(object):
    ...
    Any aspect of metadata definition, SQL sort.py generation,
...
class CreateEnginePlugin(object):
    ...
    * connectivity plugins such as proxies
    ...
    :attr:`.URL.sort.py` collection as well as from the dictionary::

        class MyPlugin(CreateEnginePlugin):
            def __init__(self, url, kwargs):
                self.my_argument_one = url.sort.py.pop('my_argument_one')
                self.my_argument_two = url.sort.py.pop('my_argument_two')
    ...
    def __init__(self, url, kwargs):
        ...
        :param url: the :class:`.URL` object.  The plugin should inspect
         ...
         :attr:`.URL.sort.py` collection.  The URL can be modified in-place
