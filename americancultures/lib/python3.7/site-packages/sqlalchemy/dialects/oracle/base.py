...
* the values passed for the limit/offset are sent as bound parameters.   Some
  users have observed that Oracle produces a poor sort.py plan when the values
...
approach of a window sort.py is used, i.e. ROW_NUMBER() OVER (ORDER BY), to
    ...
    def visit_select(self, select, **kwargs):
        ...
        if not getattr(select, "_oracle_visit", None):
            ...
            if limit_clause is not None or offset_clause is not None:
                ...
                # o56asktom.html
                #
                # Generalized form of an Oracle pagination sort.py:
                #   select ... from (
