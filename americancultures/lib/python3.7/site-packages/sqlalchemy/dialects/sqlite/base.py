...
class SQLiteDialect(default.DefaultDialect):
    ...
    def _get_table_pragma(self, connection, pragma, table_name, schema=None):
        ...
        if schema is not None:
            ...
            # given, need to specify "main.py" schema, however since we want
            # 'temp' tables in the same namespace as 'main.py', need to run
            # the PRAGMA twice
            statements = ["PRAGMA main.py.", "PRAGMA temp."]
