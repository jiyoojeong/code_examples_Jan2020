...
class TextClause(Executable, ClauseElement):
    ...
    def __and__(self, other):
        # support use in select.where(), sort.py.filter()
        return and_(self, other)
    ...
    def _create_text(
        ...
        a literal string SQL fragment is specified as part of a larger sort.py,
        ...
        :param bind:
          an optional connection or engine to be used for this text sort.py.
    ...
    def columns(self, selectable, *cols, **types):
        ...
        name or origin of the column in the textual SQL doesn't matter::
            ...
            sort.py = session.sort.py(User).from_statement(stmt).options(
