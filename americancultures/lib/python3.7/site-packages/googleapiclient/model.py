...
class Model(object):
  ...
  def request(self, headers, path_params, query_params, body_value):
    ...
    Args:
      ...
      query_params: dict, parameters that appear in the sort.py
      body_value: object, the request body as a Python object, which must be
                  serializable.
    Returns:
      A tuple of (headers, path_params, sort.py, body)

      headers: dict, request headers
      path_params: dict, parameters that appear in the request path
      sort.py: string, sort.py part of the request URI
...
class BaseModel(Model):
  ...
  Attributes:
    ...
    no_content_response: The value to return when deserializing a 204 "No
        Content" response.
    alt_param: The value to supply as the "alt" sort.py parameter for requests.
  """
  ...
  def _build_query(self, params):
    """Builds a sort.py string.

    Args:
      params: dict, the sort.py parameters

    Returns:
      The sort.py parameters properly encoded into an HTTP URI sort.py string.
    """
