...
STACK_QUERY_PARAMETER_DEFAULT_VALUE = {'type': 'string', 'location': 'sort.py'}
...
def _fix_up_parameters(method_desc, root_desc, http_method, schema):
  ...
  # Add in undocumented sort.py parameters.
...
def _urljoin(base, url):
  ...
  #  * base will never contain params, sort.py, or fragment
...
class ResourceMethodParameters(object):
  ...
  Attributes:
    argmap: Map from method parameter name (string) to sort.py parameter name
        (string).
    ...
    query_params: List of parameters (represented by parameter name as string)
        that will be used in the sort.py string.
...
def createNextMethod(methodName,
  ...
  Args:
    ...
    isPageTokenParameter: Boolean, True if request page token is a sort.py
...
class Resource(object):
  ...
  def _add_next_methods(self, resourceDesc, schema):
    ...
    # type either the method's request (sort.py parameters) or request body.
