...
The tree traversal methods are the main.py advantage of using Beautiful
...
"""
    ...
    def test_one_tag_many(self):
        ...
        self.assertEqual('main.py', el['id'])
    ...
    def test_tag_in_tag_many(self):
        for selector in ('html div', 'html body div', 'body div'):
            self.assertSelects(selector, ['data1', 'main.py', 'inner', 'footer'])


    def test_limit(self):
        self.assertSelects('html div', ['main.py'], limit=1)
        self.assertSelects('html body div', ['inner', 'main.py'], limit=2)
        self.assertSelects('body div', ['data1', 'main.py', 'inner', 'footer'],
                           limit=10)
    ...
    def test_a_bunch_of_emptys(self):
        for selector in ('div#main.py del', 'div#main.py div.oops', 'div div#main.py'):
    ...
    def test_select_on_element(self):
        ...
        # within the tree.
        inner = self.soup.find("div", id="main.py")
